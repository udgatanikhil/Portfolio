    ...
    <div className="space-y-16 max-w-4xl mx-auto py-8 md:py-16 animate-fade-up">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        ...
        <div className="md:col-span-4 flex justify-center">
          <div className="w-48 h-48 rounded-2xl overflow-hidden border border-[#eadeca] bg-white p-2.5 shadow-sm shadow-stone-200/50">
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-earth-green font-semibold tracking-wider block">01 / DIAGNOSTICS</span>
            <h4 className="text-sm font-bold text-slate-800 tracking-wide font-sans">
              Data-Driven Process
            </h4>
          ...
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-earth-blue font-semibold tracking-wider block">02 / COMPLIANCE</span>
            <h4 className="text-sm font-bold text-slate-800 tracking-wide font-sans">
              Architectural Rigor
            </h4>
          ...
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-earth-green font-semibold tracking-wider block">03 / STARK AUTOMATION</span>
            <h4 className="text-sm font-bold text-slate-800 tracking-wide font-sans">
