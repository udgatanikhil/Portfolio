          ...
          >
            <div className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-slate-805 tracking-tight">
                  {project.title}
                </h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pt-4">
                ...
                <div className="md:col-span-8 space-y-8">
                  ...
                  {/* Project Outcome */}
                  <div className="border-l-2 border-emerald-600 pl-5 space-y-2 bg-emerald-50/20 py-4 pr-4 rounded-r-lg">
