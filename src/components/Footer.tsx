...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 mt-auto py-8 transition-colors duration-300 pb-20 md:pb-8">
